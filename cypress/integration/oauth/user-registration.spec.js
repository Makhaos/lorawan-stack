...
describe('OAuth user registration', () => {
  ...
  it('should validate before submitting an empty form', () => {
    ...
    cy.findErrorByLabelText('User ID').as('userIdError')
    cy.get('@userIdError')
    ...
    cy.get('@userIdError')
      ...
      .and('be.visible')
    cy.findErrorByLabelText('Email').as('emailError')
    cy.get('@emailError')
    ...
    cy.get('@emailError')
      .should('contain', 'is required')
      .and('be.visible')
    cy.findErrorByLabelText('Password').as('passwordError')
    ...
    cy.get('@passwordError')
      .should('contain', 'is required')
      .and('be.visible')
    cy.findErrorByLabelText('Confirm password').as('confirmPasswordError')
